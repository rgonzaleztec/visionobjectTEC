...
# Para UBIDOTS
TOKEN = "fUANENM2wZj0pMjtCpG0JujU7ionnD"  # Put your TOKEN here
DEVICE_LABEL = "tensorflow"  # Put your device label here 
tubo_largo = "tubo-largo"  # Put your first variable label here
tapa_de_la_bolsa = "tapa-de-la-bolsa"  # Put your second variable label here
sets_enteral = "sets-enteral"  # Put your second variable label here
pouch = "pouch"
caset ="caset"
bolsita_interior = "bolsita-interior"
fecha = "fecha"
manguera = "manguera"
tapa = "tapa"
...
#Funcion para cargar datos a Ubidots

def build_payload(variable_1, valor):
    # Creates two random values for sending data
    payload = {variable_1 : valor}
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    if strClassification == "codigo":
                        payload = build_payload(codigobarras,1);
                    elif strClassification == "sets enteral":  
                        payload = build_payload(sets_enteral,1);
                    elif strClassification == "bolsita interior": 
                        payload = build_payload(bolsita_interior, 1);
                    elif strClassification == "fecha":   
                        payload = build_payload(fecha, 1);
                    elif strClassification == "tapita":   
                        payload = build_payload(tapa, 1);
                    elif strClassification == "caset":   
                        payload = build_payload(caset, 1);
                    elif strClassification == "pouch":   
                        payload = build_payload(pouch, 1);
                    elif strClassification == "tubo largo":  
                        payload = build_payload(tubo_largo, 1);
                    elif strClassification == "tapa de la bolsita":  
                        payload = build_payload(tapa_de_la_bolsa, 1);
                    elif strClassification == "cable solo": 
                        payload = build_payload(tubo_largo, 1);
                    else:
